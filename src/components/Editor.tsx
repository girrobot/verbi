...
function getSuggestionColor(type: 'grammar' | 'style' | 'clarity'): string {
  switch (type) {
    case 'grammar':
...
function getSuggestionIconBg(type: 'grammar' | 'style' | 'clarity'): string {
  switch (type) {
    case 'grammar':
      return 'bg-red-100'
    case 'style':
...
function getSuggestionIcon(type: 'grammar' | 'style' | 'clarity') {
  switch (type) {
    case 'grammar':
      return (
